  ...
  template: `
    <div class="bg-amber-50 min-h-screen py-12">
      <div class="container mx-auto px-4">
        ...
        <!-- Main Card -->
        <div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden print:shadow-none print:max-w-full relative">
          
          <div class="bg-red-900 text-white p-6 text-center print:hidden relative z-20">
          ...
          <div class="p-8 relative bg-stone-50/50">
            ...
            <div class="relative z-10">
                ...
                @if (step() === 'form') {
                  ...
                  <!-- Bank Transfer Info -->
                  @if (paymentMode === 'bank') {
                     <div class="bg-white/80 backdrop-blur-sm p-6 rounded-xl border border-stone-200 mb-8 animate-fade-in shadow-sm">
                  ...
                  <form (submit)="processPayment($event)" class="bg-white/90 backdrop-blur-sm p-6 rounded-xl border border-stone-200 shadow-sm">
                    <!-- Secure Badge -->
                    @if (paymentMode === 'online') {
                        <div class="flex items-center justify-center gap-2 mb-6 text-green-700 bg-green-50 p-2 rounded-lg border border-green-200">
                    ...
                    <button *ngIf="paymentMode === 'online'" type="submit" class="w-full bg-gradient-to-r from-amber-600 to-amber-700 text-white font-bold py-4 rounded-xl shadow-lg hover:from-amber-700 hover:to-amber-800 transform hover:-translate-y-1 transition-all flex items-center justify-center gap-2">
